...
const rows = [
  ...
  createData(2007, '1,163,365', '1,074,892  ', '16.3%  ', '7.5% ','16.3%  ','7.5%  '),
...
function Rentabilidad() {
  return (
    <div className='flex flex-col mb-32'>
        <div>
    <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Rentabilidad total anual de una inversión de US$ 1 millón</h1>
    <h2 class="text-4xl mb-6 font-bold ">Incluye reinversión de dividendos</h2>
    ...
    <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
      <TableHead>
        ...
        <TableCell align="center" colSpan={2}>Rentabilidad*  Anual YoY</TableCell>
        <TableCell align="center" colSpan={2}>Rentabilidad*  Anual Compuesta</TableCell>
        </TableRow>
        <TableRow>
