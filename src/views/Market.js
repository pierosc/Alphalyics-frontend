...
MARKET
  ...
  <div  className="w-5/6 bg-white border border-gray-200 rounded-3xl shadow-2xl md:p-16 p-6 md:m-16 m-4">

          <h2  className="md:text-4xl text-xl mb-8 font-bold ">
          Incorporación de un socio gestor. La empresa está valorizada en US$ 85k. Se necesita un aporte de capital para: 
            </h2>
            <ul  className="space-y-1 md:text-2xl text-lg mb-8 list-disc list-inside text-gray-500">
              <li>
          ...
          El mercado de salida será Perú
            ...
            <ul  className="space-y-1 md:text-2xl  text-lg list-disc mb-8 list-inside text-gray-500">
              <li>
